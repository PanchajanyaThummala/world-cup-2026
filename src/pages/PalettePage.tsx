...
const PALETTES:P[] = [
  ...
  mk('l3','Glacier','Light','Ice blue · dark navy · white','#EFF6FF','#FFFFFF','#1D4ED8','#1E3A5F','#93C5FD','29,78,216','#DBEAFE','#1D4ED8','#FFFFFF'),
  mk('l4','Graphite Clean','Light','Warm white · graphite · gold accent','#FAFAFA','#FFFFFF','#C9A029','#171717','#737373','201,160,41','#F5F5F5'),
  mk('l5','Coral Energy','Light','Off-white · coral red · charcoal','#FFF5F5','#FFFFFF','#E53E3E','#1A1A1A','#9B6B6B','229,62,62','#FED7D7','#E53E3E','#FFFFFF'),
  mk('l6','Mint Fresh','Light','Very light mint · deep green · white','#F0FDF4','#FFFFFF','#15803D','#052E16','#4ADE80','21,128,61','#DCFCE7','#15803D','#FFFFFF'),
  mk('l7','Pearl & Navy','Light','Pearl white · deep navy · gold','#FEFEFE','#FFFFFF','#1E3A5F','#0F172A','#94A3B8','30,58,95','#F0F4F8','#C9A029','#0F172A'),
  mk('l8','Linen & Gold','Light','Warm linen · dark chocolate · gold','#FAF7F2','#FFFFFF','#92400E','#1C0D04','#A38060','146,64,14','#F5EFE6','#92400E','#FAF7F2'),
  mk('l9','Sky Sport','Light','Sky blue · dark navy · white','#F0F9FF','#FFFFFF','#0369A1','#0C2340','#7DD3FC','3,105,161','#E0F2FE','#0369A1','#FFFFFF'),
  mk('l10','Ivory & Scarlet','Light','Ivory · deep scarlet · black','#FFFAF0','#FFFFFF','#9B1C1C','#1A0A0A','#C4876A','155,28,28','#FEF3C7','#9B1C1C','#FFFAF0'),
  mk('l11','Nordic Light','Light','Almost white · charcoal · red','#F9FAFB','#FFFFFF','#DC2626','#111827','#6B7280','220,38,38','#F3F4F6','#DC2626','#FFFFFF'),
  mk('l12','Blush Sport','Light','Warm white · blush · dark navy','#FFF5F7','#FFFFFF','#DB2777','#0F172A','#F9A8D4','219,39,119','#FDE8F0','#DB2777','#FFFFFF'),
  // ── VIBRANT (12) ───────────────────────────────────────────────────────────
